...
from info import CLONE_MODE, CHANNELS, SYD, REQUEST_TO_JOIN_MODE, TRY_AGAIN_BTN, ADMINS, SHORTLINK_MODE, PREMIUM_AND_REFERAL_MODE, STREAM_MODE, AUTH_CHANNEL, OWNER_USERNAME, REFERAL_PREMEIUM_TIME, REFERAL_COUNT, PAYMENT_TEXT, PAYMENT_QR, LOG_CHANNEL, PICS, BATCH_FILE_CAPTION, CUSTOM_FILE_CAPTION, PROTECT_CONTENT, CHNL_LNK, GRP_LNK, REQST_CHANNEL, SUPPORT_CHAT_ID, SUPPORT_CHAT, MAX_B_TN, VERIFY, SHORTLINK_API, SHORTLINK_URL, TUTORIAL, VERIFY_TUTORIAL, IS_TUTORIAL, URL
from utils import get_settings, pub_is_subscribed, get_size, is_subscribed, save_group_settings, temp, verify_user, check_token, check_verification, check_sydtoken, sydfy_user, update_sydfy_status, get_sydfy_status, get_token, check_sydfication, get_shortlink, get_tutorial, get_seconds, VERIFIED
from database.connections_mdb import active_connection
from urllib.parse import quote_plus
from MrSyD.util.file_properties import get_name, get_hash, get_media_file_size
   ...
   # await message.react(emoji=random.choice(PIS))
    ...
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
            ...
            InlineKeyboardButton('✪ Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="bot_cracker"),
            InlineKeyboardButton('⌬ Mᴏᴠɪᴇ Gʀᴏᴜᴘ', url='https://t.me/+Ug0QUf9-1xo5ODVl')
        ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        if REQUEST_TO_JOIN_MODE == True:
            if TRY_AGAIN_BTN == True:
                text = "<blockquote><b>🕵️ Jᴏɪɴ Tʜᴇ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Tᴏ Gᴇᴛ Mᴏᴠɪᴇ Fɪʟᴇ\n\n👨‍💻 Fɪʀsᴛ Cʟɪᴄᴋ Oɴ Jᴏɪɴ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Bᴜᴛᴛᴏɴ, Tʜᴇɴ Cʟɪᴄᴋ Oɴ Rᴇǫᴜᴇsᴛ Tᴏ Jᴏɪɴ Bᴜᴛᴛᴏɴ Aғᴛᴇʀ Cʟɪᴄᴋ Oɴ Tʀʏ Aɢᴀɪɴ Bᴜᴛᴛᴏɴ.</b></blockquote>"
            else:
                await db.set_msg_command(message.from_user.id, com=message.command[1])
                text = "<blockquote><b>🕵️ Jᴏɪɴ Tʜᴇ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Tᴏ Gᴇᴛ Mᴏᴠɪᴇ Fɪʟᴇ\n\n👨‍💻 Fɪʀsᴛ Cʟɪᴄᴋ Oɴ Jᴏɪɴ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Bᴜᴛᴛᴏɴ, Tʜᴇɴ Cʟɪᴄᴋ Oɴ Rᴇǫᴜᴇsᴛ Tᴏ Jᴏɪɴ Bᴜᴛᴛᴏɴ.</b></blockquote>"
        else:
            text = "<blockquote><b>🕵️ Jᴏɪɴ Tʜᴇ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Tᴏ Gᴇᴛ Mᴏᴠɪᴇ Fɪʟᴇ\n\n👨‍💻 Fɪʀsᴛ  Cʟɪᴄᴋ Oɴ Jᴏɪɴ Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ Bᴜᴛᴛᴏɴ, Tʜᴇɴ Jᴏɪɴ Cʜᴀɴɴᴇʟ Aғᴛᴇʀ Cʟɪᴄᴋ Oɴ Tʀʏ Aɢᴀɪɴ Bᴜᴛᴛᴏɴ</b></blockquote>"
    ...
    elif data.split("-", 1)[0] == "disclaimer":
        await message.reply_text("""
<b>Tᴇʀᴍꜱ ᴀɴᴅ Cᴏɴᴅɪᴛɪᴏɴꜱ ;
Nᴇᴠᴇʀ ꜱᴜᴩᴩᴏʀᴛ ᴩɪʀᴀᴄʏ 

Nᴇᴠᴇʀ ᴀꜱᴋ ᴏʀ ꜰᴏʀᴄᴇ ᴀɴʏ ᴏɴᴇ ꜰᴏʀ ᴍᴏɴᴇʏ 

Tʀʏɪɴɢ ᴛᴏ ᴅᴏ ᴏʀ ɢᴏ ᴀɢᴀɪɴꜱᴛ ᴩᴏʟɪᴄʏ ᴡɪʟʟ ʟᴇᴀᴅ ᴛᴏ ᴛʜᴇ ᴅᴇʟᴇᴛᴀᴛɪᴏɴ ᴏꜰ ʙᴏᴛ

Fᴏʟʟᴏᴡ ᴏᴜʀ ᴩᴏʟɪᴄɪᴇꜱ ᴄᴏʀʀᴇᴄᴛʟʏ

Wᴇ ᴀʀᴇ ɴᴏᴛ ʀᴇꜱᴩᴏɴꜱɪʙʟᴇ ꜰᴏʀ ᴀɴʏ ᴀᴄᴛɪᴏɴ, ᴍᴀᴅᴇ ʙʏ ᴀɴʏᴏɴᴇ ɪɴ ʏᴏᴜʀ ʙᴏᴛ!

Wᴇ ᴀʀᴇ ɴᴏᴛ ꜰᴏʀᴄɪɴɢ ᴀɴʏᴏɴᴇ ᴛᴏ ᴄʀᴇᴀᴛᴇ ᴛʜᴇ ʙᴏᴛ, ɪᴛꜱ ᴛʜᴇᴍ ɴᴏᴛ ᴜꜱ!

Dɪꜱᴄʟᴀɪᴍᴇʀ;

Wᴇ  ᴅᴏɴᴛ ꜱᴜᴩᴩᴏʀᴛ ᴩɪʀᴀᴄʏ, ɪꜰ ᴀɴʏ ᴏꜰ ᴄʟᴏɴᴇ ʙᴏᴛ ɪꜱ ᴠɪᴏʟᴀᴛɪɴɢ ᴀɴʏᴛʜɪɴɢ ᴩʟᴇᴀꜱᴇ ʀᴇᴩᴏʀᴛ ᴜꜱ[ᴡᴇ ʜᴀᴠᴇ ɢɪᴠᴇɴ ᴛʜᴇᴍ ᴩʀᴏᴩᴇʀ ɪɴꜱᴛʀᴜᴄᴛɪᴏɴ ᴀɴᴅ ᴡᴇ ᴀʀᴇ ɴᴏᴛ ʀᴇꜱᴩᴏɴꜱɪʙʟᴇ], ᴡᴇ ᴡɪʟʟ ᴛᴀᴋᴇ ɴᴇᴄᴇꜱꜱᴀʀʏ ᴀᴄᴛɪᴏɴ ᴇʟꜱᴇ ᴛʜᴇ ᴏᴡɴᴇʀ ᴏꜰ ᴛʜᴀᴛ ʙᴏᴛ ɪꜱ ᴛʜᴇ ᴏɴʟʏ ʀᴇꜱᴩᴏɴꜱɪʙʟᴇ ʜᴇʀᴇ,
