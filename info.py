...
# Ask Doubt on telegram @Bot_cracker
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002473582716') # give your force subscribe channel id here else leave it blank
...
REFERAL_COUNT = environ.get('REFERAL_COUNT', '20') # number of referal count
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Syd_XyZ') # owner username without @
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+eEF_leRCgBplODI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Bot_Cracker')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'bot_cracker') # Support Chat Link Without https:// or @
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '36d6dd04a79634bb5a4ae150903c78b9c9121ce6')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', '')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', '')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/Mod_Moviez_X')
...
MSG_ALRT = environ.get('MSG_ALRT', 'Hᴀᴀ! ⚡')
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "wide-christan-nclon-c87d2359.koyeb.app/")
