...
from info import AUTH_CHANNEL, DATABASE_NAME, USER_DB_URI, DATABASE_URI, CUSTOM_FILE_CAPTION, IMDB, IMDB_TEMPLATE, MELCOW_NEW_USERS, P_TTI_SHOW_OFF, SINGLE_BUTTON, SPELL_CHECK_REPLY, PROTECT_CONTENT, AUTO_DELETE, MAX_BTN, AUTO_FFILTER, SHORTLINK_API, SHORTLINK_URL, IS_SHORTLINK, TUTORIAL, PICS, IS_TUTORIAL
import time
...
class Database:
    ...
    async def get_syd(self, user_id):
        syd_data = await self.bot.find_one({"user_id": user_id})
        return syd_data
